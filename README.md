...
- create_tables.py: 
    - Cleans previous schema and creates new tables with proper constrains and relationship using Python  API.
    - It uses functions create_database, drop_tables (if exists initially), and create_tables to create the database sparkifydb and the required tables.
- sql_queries.py: All queries used in the ETL pipeline. DROP, CREATE, INSERT, and SELECT queries are defined here.
